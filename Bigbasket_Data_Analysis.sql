...
#                                                            Data Cleaning                                                                  #
# ------------------------------------------------------------------------------------------------------------------------------------------#
UPDATE Bigbasket Grocery Data set `Item Fat Content` = 'Regular' where `Item Fat Content` = 'reg';
UPDATE Bigbasket Grocery Data set `Item Fat Content` = 'Low Fat' where `Item Fat Content` = 'LF' or `Item Fat Content` = 'low Fat';
...
SELECT COUNT(*) AS Total_No_Items from Bigbasket Grocery Data;
